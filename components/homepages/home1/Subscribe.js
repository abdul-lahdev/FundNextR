          ...
          <div className="row">
                    ...
                    <div className="sliderImageSetting">
                      <UniversalSlider>
                        {sliderImageUrl.map((ele, index) => (
                          ...
                          >
                            <div className="setSmScreenWIdth">
            ...
            <Col xxl={12} className="mt-5">
              <div className="colaborativeVenture">
                <div>
                  ...
                  <div className="d-flex gap-5 mt-4 setSmallerDevice">
                ...
                <div>
                  ...
                  <div className="d-flex align-items-center justify-content-xxl-center justify-content-xl-center justify-content-lg-start justify-content-md-start justify-content-sm-start justify-content-start">
                    <img
            ...
            <Col xxl={12} className="mt-5">
              <div className="tradeSmartContainer mt-5">
                ...
                <div className="d-xxl-flex d-xl-flex d-lg-flex d-md-column d-sm-column d-column setBottomBtmSM align-items-center gap-3 justify-content-center mt-4">
