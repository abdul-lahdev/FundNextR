    ...
    <>
      <div className="about-area section-padding bg5 pt-0 mt-0">
        <div className="container ">
          <div className="tradingPlatGrid" style={{ overflow: "hidden" }}>
            <div
            ...
            >
              ...
              <div className="guarantedSideBox  setSecondColor">
                <div>
                ...
                <div className="hoverUpAnimation">
                  <div className="etsFirstItem">
                    <div className="contentItemSet">
                      ...
                      <div className="d-flex align-items-center gap-xxl-5 gap-xl-5 gap-lg-5 gap-md-5 gap-sm-3 gap-3 mt-4">
