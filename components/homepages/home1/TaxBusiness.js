...
export default function TaxBusiness() {
  return (
    <>
      <div className="tax-business section-padding2 bg6 pt-3" id="about">
        <div className="container ">
          <div className="row justify-content-between">
            <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-12 col-sm-12 col-12">
              <div className="setGapSm h-100 d-flex flex-column justify-content-xxl-between justify-content-xl-between justify-content-lg-start justify-content-md-start justify-content-sm-start justify-content-start">
                <div>
                  <h1
            ...
            <div className="col-xxl-9 col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12">
              <div className="keyHighlightsGrid" style={{ overflow: "hidden" }}>
