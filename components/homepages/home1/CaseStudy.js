...
import SmallTabsItem from "@/components/smallNavingBar/SmallTabsItem";
...
export default function CaseStudy() {
  ...
  return (
    <>
      <div
        className="d-flex justify-content-center setTranslate"
        style={{ overflow: "hidden", transform: "translate(2%, 0px)" }}
      >
        <div className="setFullWidth">
                ...
                <div className="pricingTabSetting d-flex flex-column align-items-center justify-content-center">
                  <PlanTabs>
                    ...
                    >
                      ...
                      <div className="PricingTableSetting d-xxl-block d-xl-block d-lg-block d-md-none d-sm-none d-none">
                        {stepValue ? (
                          <>
                            <PricingTable>
                              <thead>
